...
public interface RangeContainerFactory {
	...
	*/
	...
	/**
	 * create container with give size
	 * @param maxSize
	 * @return
	 */
	RangeContainer createContainer(int size);
	

	/**
	 * create container with give size, data and id
	 * @param maxSize
	 * @return
	 */
	RangeContainer createContainer(int maxSize, int id);
